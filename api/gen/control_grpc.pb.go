...
const (
	NodeControl_List_FullMethodName    = "/cellar.v1.NodeControl/List"
	NodeControl_Inspect_FullMethodName = "/cellar.v1.NodeControl/Inspect"
)
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// NodeControl is served on managers (mTLS). Reads on any manager.
type NodeControlClient interface {
	List(ctx context.Context, in *NodeListRequest, opts ...grpc.CallOption) (*NodeListResponse, error)
	Inspect(ctx context.Context, in *NodeInspectRequest, opts ...grpc.CallOption) (*NodeInspectResponse, error)
}
...
func (c *nodeControlClient) List(ctx context.Context, in *NodeListRequest, opts ...grpc.CallOption) (*NodeListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NodeListResponse)
	err := c.cc.Invoke(ctx, NodeControl_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeControlClient) Inspect(ctx context.Context, in *NodeInspectRequest, opts ...grpc.CallOption) (*NodeInspectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NodeInspectResponse)
	err := c.cc.Invoke(ctx, NodeControl_Inspect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeControlServer interface {
	...
	Inspect(context.Context, *NodeInspectRequest) (*NodeInspectResponse, error)
...
func (UnimplementedNodeControlServer) List(context.Context, *NodeListRequest) (*NodeListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedNodeControlServer) Inspect(context.Context, *NodeInspectRequest) (*NodeInspectResponse, error) {
...
func _NodeControl_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeControlServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeControl_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeControlServer).List(ctx, req.(*NodeListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _NodeControl_Inspect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeInspectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeControlServer).Inspect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeControl_Inspect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeControlServer).Inspect(ctx, req.(*NodeInspectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeControl_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cellar.v1.NodeControl",
	HandlerType: (*NodeControlServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "List",
			Handler:    _NodeControl_List_Handler,
		},
		{
			MethodName: "Inspect",
			Handler:    _NodeControl_Inspect_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "control.proto",
