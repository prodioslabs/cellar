...
const SCRIPT: Step[] = [
  ...
  },
  {
    ...
    output: [
      'ID          HOSTNAME     TYPE     STATUS  AVAILABILITY  MANAGER STATUS  SANDBOXES',
      '1a2b3c4d    192.0.2.10   leader   ready   active        leader          0',
      '2b3c4d5e    192.0.2.11   manager  ready   active        reachable       0',
      '9e8d7c6b    192.0.2.12   worker   ready   active                        0',
      '8d7c6b5a    192.0.2.13   worker   ready   active                        0',
    ],
    stage: 4,
  },
  {
