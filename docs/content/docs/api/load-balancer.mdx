...
The Terraform example under `terraform/` provisions this ALB with an AWS cluster. See [Infrastructure with Terraform](/docs/install/terraform) for IaC layout, nested virtualization, and instance-type requirements.
